...
{
    switch (d) {
        case ExtendedDirection::Up:
            return {0, -1};
        case ExtendedDirection::UpRight:
            return {1, -1};
        case ExtendedDirection::Right:
            return {1, 0};
        case ExtendedDirection::DownRight:
            return {1, 1};
        case ExtendedDirection::Down:
            return {0, 1};
        case ExtendedDirection::DownLeft:
            return {-1, 1};
        case ExtendedDirection::Left:
            return {-1, 0};
