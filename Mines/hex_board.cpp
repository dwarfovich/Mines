...
//#include "gui/hex_board_cell_item.hpp"
...
{
    StandardCellItem::setSprites(":/gfx/cells_hex.png");
    ...
    for (size_t i = 0; i < height_; ++i) {
        for (size_t j = 0; j < width_; ++j) {
            ...
            auto* item = new StandardCellItem {cell};
        qreal row = cell->id / cols;
        qreal col = cell->id % cols;
        double sprite_size = StandardCellItem::size();
